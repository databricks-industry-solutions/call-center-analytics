...
# MAGIC %run ./util/data-prep-german

# COMMAND ----------

df = spark.read.table("german_paths_with_ids")
...
transcribed.write.mode("overwrite").saveAsTable("bergmann_transcriptions")

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM bergmann_transcriptions
...
binary_df = spark.read.table("bergmann_binary_audio_with_ids")
